...
<html lang="en">
  <head>
    ...
    <title>Shoes - Brand Bazaar</title>
        ...
        <div class="nav-links" id="navLinks">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a href="shoes.php" class="category-link active">Shoes</a>
            </div>
          </div>
        </div>
        <div class="nav-icons">
    ...
    <main>
      ...
      <section class="category-hero">
        <div class="category-container">
          ...
          <p>
            Discover the latest footwear trends from top brands. From running
            shoes to formal wear, find the perfect pair for every occasion.
          </p>
        </div>
      </section>
        ...
        <div class="category-content">
          ...
          <aside class="filter-section">
            ...
            <div class="filter-group">
              ...
              <div class="filter-options">
                ...
                <div class="filter-option">
                  ...
                  <label for="price-3">$100 - $150</label>
                </div>
                <div class="filter-option">
                  <input type="radio" id="price-4" name="price" />
                  <label for="price-4">Over $150</label>
                </div>
              </div>
            </div>
            ...
            <div class="filter-group">
              ...
              <div class="filter-options">
                <div class="filter-option">
                  <input type="checkbox" id="category-sneakers" checked />
                  <label for="category-sneakers">Sneakers</label>
                </div>
                <div class="filter-option">
                  <input type="checkbox" id="category-running" checked />
                  <label for="category-running">Running</label>
                </div>
                <div class="filter-option">
                  <input type="checkbox" id="category-casual" checked />
                  <label for="category-casual">Casual</label>
                </div>
                <div class="filter-option">
                  <input type="checkbox" id="category-formal" checked />
                  <label for="category-formal">Formal</label>
                </div>
                <div class="filter-option">
                  <input type="checkbox" id="category-sandals" checked />
                  <label for="category-sandals">Sandals</label>
                </div>
              </div>
            </div>
            ...
            <div class="filter-group">
              ...
              <div class="filter-options">
                ...
                <div class="filter-option">
                  <input type="checkbox" id="brand-puma" checked />
                  <label for="brand-puma">Puma</label>
                </div>
                <div class="filter-option">
                  <input type="checkbox" id="brand-newbalance" checked />
                  <label for="brand-newbalance">New Balance</label>
                </div>
                <div class="filter-option">
                  <input type="checkbox" id="brand-vans" checked />
            ...
            <div class="filter-group">
              ...
              <div class="filter-options">
                <div class="filter-option">
                  <input type="checkbox" id="feature-cushioned" checked />
                  <label for="feature-cushioned">Cushioned</label>
                </div>
                <div class="filter-option">
                ...
                <div class="filter-option">
                  <input type="checkbox" id="feature-lightweight" checked />
                  <label for="feature-lightweight">Lightweight</label>
                </div>
                <div class="filter-option">
                  <input type="checkbox" id="feature-breathable" />
                  <label for="feature-breathable">Breathable</label>
                </div>
              </div>
            </div>
          ...
          <section class="products-section">
            <div class="section-header">
              <h2><i class="fas fa-shoe-prints"></i> All Shoes</h2>
              <div>
            ...
            <div class="products-grid">
              ...
              <div class="product-card">
                ...
                <img
                  src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bmlrZSUyMHNob2VzfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"
                ...
                <div class="product-info">
                  ...
                  <p class="product-specs">
                    Men's Running Shoes • Max Air cushioning • Breathable mesh
                  </p>
                  <div class="product-price">
                    <span class="product-current">$112.50</span>
                    <span class="product-original">$150.00</span>
                    <span class="product-discount">25% OFF</span>
                  </div>
                  <div class="product-meta">
                    <span class="product-rating">
                      <i class="fas fa-star"></i> 4.7 (342)
                    </span>
              ...
              <div class="product-card">
                <img
                  src="https://images.unsplash.com/photo-1600269452121-4f2416e55c28?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8YWRpZGFzJTIwc2hvZXN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                ...
                <div class="product-info">
                  ...
                  <p class="product-specs">
                    Men's Running Shoes • Primeknit+ upper • BOOST midsole
                  </p>
                  <div class="product-price">
                    <span class="product-current">$179.99</span>
              ...
              <div class="product-card">
                ...
                <img
                  src="https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8cHVtYSUyMHNob2VzfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"
                  alt="Puma RS-X3 Puzzle"
                  class="product-image"
                />
                <div class="product-info">
                  <h3 class="product-title">Puma RS-X3 Puzzle</h3>
                  <p class="product-specs">
                    Unisex Sneakers • Chunky retro design • Cushioned footbed
                  </p>
                  <div class="product-price">
                    <span class="product-current">$83.99</span>
                    <span class="product-original">$119.99</span>
              ...
              <div class="product-card">
                ...
                <div class="product-info">
                  ...
                  <p class="product-specs">
                    Classic Sneakers • ENCAP midsole • Suede and mesh upper
                  </p>
                  <div class="product-price">
                    <span class="product-current">$84.99</span>
              ...
              <div class="product-card">
                <img
                  src="https://images.unsplash.com/photo-1543508282-6319a3e2621f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHZhbnMlMjBzaG9lc3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60"
                  alt="Vans Old Skool"
                  class="product-image"
                />
                <div class="product-info">
                  ...
                  <p class="product-specs">
                    Classic Skate Shoes • Canvas upper • Padded collar
                  </p>
                  <div class="product-price">
                    <span class="product-current">$59.99</span>
                    <span class="product-original">$64.99</span>
              ...
              <div class="product-card">
                ...
                <img
                  src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                ...
                <div class="product-info">
                  ...
                  <p class="product-specs">
                    Classic Sneakers • Leather upper • Air-Sole unit
                  </p>
                  <div class="product-price">
                    <span class="product-current">$95.99</span>
                    <span class="product-original">$119.99</span>
